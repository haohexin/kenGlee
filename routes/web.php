...
Route::get('/testOne', function (\Illuminate\Http\Request $request) {
//    dd(url()->current());
...
Route::get('/users', function (\Illuminate\Http\Request $request) {
    return new \App\Http\Resources\Users(\App\User::paginate());
});
...
Route::group(["prefix" => "admin", "namespace" => "Admin"], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        //  nav
        Route::get('nav/select', 'NavController@nav_select');
